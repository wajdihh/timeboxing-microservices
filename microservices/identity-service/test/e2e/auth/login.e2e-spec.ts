...
describe('AuthController (e2e) - /auth/login', () => {
  ...
  it('POST /auth/login - should log in a registered user with valid credentials and return tokens and increment login metric', async () => {
    ...
    expect(metricsResponse.text).toContain('identity_logins_total{method="POST"}');
  });
